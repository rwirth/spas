...
class rev5 : Program {
	...
	static class Configuration {
		...
		// Recommended values (Vanilla): 100 - 119
		public const uint TargetPowerOutput = 119;
	...
	static class Status { public const uint UPDATING = 1, TESTING = 2, ALIGNING = 3, CHECKING = 4; }
